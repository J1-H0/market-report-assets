...
{{#IF_AUX}}
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="table-layout:fixed; border-top:1px solid #d5dbe2; border-bottom:1px solid #d5dbe2; font-size:12.5px; margin-bottom:6px;">
  <tr>
  {{#AUX}}
...
{{#IF_RATE_TILES}}
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="table-layout:fixed; margin-bottom:10px;">
  <tr>
  {{#RATE_TILES}}
    <td width="{{W}}%" style="padding:4px;">
